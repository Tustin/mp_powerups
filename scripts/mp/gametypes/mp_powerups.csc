...
function main()
{
	...
	//Random Drops
	//add_mp_powerup( "insta_kill_ug",		CLIENTFIELD_POWERUP_INSTANT_KILL_UG, VERSION_SHIP );
...
function add_mp_powerup( powerup_name, client_field_name, clientfield_version = VERSION_SHIP )
{
...
*/
function include_mp_powerup( powerup_name )
{
